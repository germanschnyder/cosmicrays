...
# and the Y axis orthogonal to both.
	...
	POSTNSTZ = hdulist_spt[0].header["POSTNSTZ"]

	DATEOBS = hdulist_raw[0].header["DATE-OBS"]
	TIMEOBS = hdulist_raw[0].header["TIME-OBS"]
	...
	#Estoy seguro que puedo usar el sidereal para no tener que implementar lst, pero no se que transformación me esta faltando para pasar de arco sidereal al numero que usan para las operaciones
